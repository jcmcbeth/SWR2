...
void dam_message( CHAR_DATA *ch, CHAR_DATA *victim, int dam, int dt )
{
   ...
   /*		     10 * percent					*/
    ...
    else if ( dampc <=    2 ) { vs = "barely scratch";vp = "barely scratches";}
    else if ( dampc <=    4 ) { vs = "scratch";	vp = "scratches";	}
    else if ( dampc <=    6 ) { vs = "nick";	vp = "nicks";		}
    else if ( dampc <=    8 ) { vs = "graze";	vp = "grazes";		}
    else if ( dampc <=   10 ) { vs = "bruise";	vp = "bruises";		}
    else if ( dampc <=   15 ) { vs = "hit";	vp = "hits";		}
    else if ( dampc <=   20 ) { vs = "injure";	vp = "injures";		}
    else if ( dampc <=   25 ) { vs = "thrash";	vp = "thrashes";	}
    else if ( dampc <=   30 ) { vs = "wound";	vp = "wounds";		}
    else if ( dampc <=   35 ) { vs = "maul";    vp = "mauls";		}
    else if ( dampc <=   50 ) { vs = "decimate";vp = "decimates";	}
    else if ( dampc <=   60 ) { vs = "devastate";vp = "devastates";	}
    else if ( dampc <=   70 ) { vs = "maim";	vp = "maims";		}
    else if ( dampc <=   80 ) { vs = "MUTILATE";vp = "MUTILATES";	}
    else if ( dampc <=   90 ) { vs = "DISEMBOWEL";vp = "DISEMBOWELS";	}
    else if ( dampc <=  100 ) { vs = "MASSACRE";  vp = "MASSACRES";	}
    else if ( dampc <=  125 ) { vs = "PULVERIZE"; vp = "PULVERIZES";	}
    else if ( dampc <=  150 ) { vs = "EVISCERATE";vp = "EVISCERATES";	}
    else if ( dampc <=  200 ) { vs = "* OBLITERATE *";
			        vp = "* OBLITERATES *";			}
    else                      { vs = "*** ANNIHILATE ***";
			        vp = "*** ANNIHILATES ***";		}
